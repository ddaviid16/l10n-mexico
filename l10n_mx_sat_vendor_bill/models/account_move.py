...
class AccountMove(models.Model):
    ...
    def _l10n_mx_sat_try_purchase_match(self, cfdi_total):
        ...
        """
        self.ensure_one()
        # purchase is an optional dependency: without it there is no matching
        # machinery on account.move and nothing to do here.
        if not hasattr(self, "_find_and_set_purchase_orders"):
            return False
